...
def generate_test_description():
    ...
    point_cloud_filter_transform_node = Node(
        package="auto_point_cloud_filter_transform_nodes",
        executable="point_cloud_filter_transform_node_exe",
        name="point_cloud_filter_transform_node",
        namespace="lidar_front",
        parameters=[
            os.path.join(
                get_package_share_directory('auto_point_cloud_filter_transform_nodes'),
                'param/test.param.yaml'
            )
        ]
    )

    context = {'auto_point_cloud_filter_transform_nodes': point_cloud_filter_transform_node}
