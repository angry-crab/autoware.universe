...
#include <auto_localization_common/initialization.hpp>
...
#include <auto_localization_nodes/visibility_control.hpp>
#include <auto_localization_nodes/constraints.hpp>
#include <memory>
#include <string>
#include <tuple>
#include <utility>
