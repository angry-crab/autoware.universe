...
#include <auto_mpc_controller/mpc_controller.hpp>
...
using autoware::motion::motion_testing::bad_heading_trajectory;
using autoware::motion::motion_testing::constant_acceleration_turn_rate_trajectory;
