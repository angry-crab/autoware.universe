...
TEST_F(Transforms, StaticDynamicTfs)
{
  ...
  // Match
  (void)autoware::motion::motion_testing_nodes::wait_for_matched(*traj_pub, 1U);
  (void)autoware::motion::motion_testing_nodes::wait_for_matched(*state_pub, 1U);
  (void)autoware::motion::motion_testing_nodes::wait_for_matched(*tf_pub, 1U);
  (void)autoware::motion::motion_testing_nodes::wait_for_matched(*static_tf_pub, 1U);
  // Spin
  {
