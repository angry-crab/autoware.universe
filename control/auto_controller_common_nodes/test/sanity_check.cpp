...
#include <auto_controller_common_nodes/controller_base_node.hpp>
#include <motion_common/motion_common.hpp>
#include <auto_motion_testing/motion_testing.hpp>
#include <auto_motion_testing_nodes/motion_testing_publisher.hpp>
#include <auto_motion_testing_nodes/wait_for_matched.hpp>
...
using autoware::motion::motion_testing_nodes::State;
using autoware::motion::motion_testing_nodes::TFMessage;
using autoware::motion::motion_testing_nodes::Trajectory;
using autoware::motion::motion_testing_nodes::TrajectoryProfile;
using autoware::motion::motion_testing::make_state;
...
public:
  ...
  void match() const
  {
    (void)autoware::motion::motion_testing_nodes::wait_for_matched(*m_traj_sub, 1U);
    (void)autoware::motion::motion_testing_nodes::wait_for_matched(*m_state_sub, 1U);
    (void)autoware::motion::motion_testing_nodes::wait_for_matched(*m_tf_sub, 1U);
    (void)autoware::motion::motion_testing_nodes::wait_for_matched(*m_cmd_sub, 1U);
    (void)autoware::motion::motion_testing_nodes::wait_for_matched(*m_diag_sub, 1U);
  }
...
TEST_F(SanityCheck, Basic)
{
  ...
  const auto pub = std::make_shared<autoware::motion::motion_testing_nodes::MotionTestingPublisher>(
