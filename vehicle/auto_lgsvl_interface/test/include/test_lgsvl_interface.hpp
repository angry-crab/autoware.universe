...
#include <auto_lgsvl_interface/visibility_control.hpp>
#include <auto_lgsvl_interface/lgsvl_interface.hpp>
...
protected:
  void SetUp() override
  {
    ...
    lgsvl_interface_ = std::make_unique<auto_lgsvl_interface::LgsvlInterface>(
      *node_,
      sim_ctrl_cmd_topic,
      sim_state_cmd_topic,
      sim_state_rpt_topic,
...
public:
  ...
  std::unique_ptr<auto_lgsvl_interface::LgsvlInterface> lgsvl_interface_;
