...
#include "auto_lgsvl_interface/lgsvl_interface_node.hpp"
...
namespace auto_lgsvl_interface
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(auto_lgsvl_interface::LgsvlInterfaceNode)
