...
#include <auto_behavior_planner_nodes/behavior_planner_node.hpp>
#include <auto_behavior_planner_nodes/visibility_control.hpp>
...
#include <auto_behavior_planner/behavior_planner.hpp>
