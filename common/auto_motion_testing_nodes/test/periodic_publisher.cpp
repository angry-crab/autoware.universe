...
#include <auto_motion_testing_nodes/periodic_publisher.hpp>

#include <memory>
#include <string>
#include <vector>

using autoware::motion::motion_testing_nodes::PeriodCountTopic;
using autoware::motion::motion_testing_nodes::PeriodicPublisher;
