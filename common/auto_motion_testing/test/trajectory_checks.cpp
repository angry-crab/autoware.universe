...
using autoware::motion::motion_testing::State;
using autoware::motion::motion_testing::Trajectory;
using autoware::motion::motion_testing::make_state;
using autoware::motion::motion_testing::constant_velocity_trajectory;
...
TEST(TrajectoryChecks, Basic)
{
  ...
  using autoware::motion::motion_testing::progresses_towards_target;
  using autoware::motion::motion_testing::dynamically_feasible;
  // Empty case
