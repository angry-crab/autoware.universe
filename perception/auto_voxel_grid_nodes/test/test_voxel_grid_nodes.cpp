...
#include <auto_voxel_grid_nodes/algorithm/voxel_cloud_approximate.hpp>
#include <auto_voxel_grid_nodes/algorithm/voxel_cloud_centroid.hpp>
#include <auto_voxel_grid_nodes/voxel_cloud_node.hpp>
