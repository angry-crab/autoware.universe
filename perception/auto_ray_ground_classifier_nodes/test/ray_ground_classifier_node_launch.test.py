...
def generate_test_description():
    ...
    ray_ground_classifier_node = Node(
        package='auto_ray_ground_classifier_nodes',
        executable='ray_ground_classifier_cloud_node_exe',
        namespace='test',
        parameters=[os.path.join(
            get_package_share_directory('auto_ray_ground_classifier_nodes'),
            'param/test.param.yaml'
        )]
    )

    context = {'auto_ray_ground_classifier_node': ray_ground_classifier_node}
