...
#include <auto_lidar_utils/point_cloud_utils.hpp>
#include <auto_ray_ground_classifier_nodes/visibility_control.hpp>
#include <auto_ray_ground_classifier/ray_aggregator.hpp>
#include <auto_ray_ground_classifier/ray_ground_classifier.hpp>
